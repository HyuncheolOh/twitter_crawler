...
class twitter_bot(object):
    ...
    def bot_prediction_algorithm(self, df):
...
if __name__ == '__main__':
    ...
    filepath = 'kaggle_data/'
    train_df = pd.read_csv(filepath + 'training_data_2_csv_UTF.csv')
    test_df1 = pd.read_csv(filepath + 'test_data_4_students.csv', sep='\t', encoding='ISO-8859-1')
    #print(test_df)
    ...
    #get all files in bot folder 
    folder_path = '/media1/Fakenews/Twitter/crawler/TwitterAPI/Network/Data/Bot_info/'
    result_d = {}
    #print(test_df)
    #folder_path = '/media1/Fakenews/Twitter/crawler/TwitterAPI/Network/Data/Bot_info/bot_user_info.csv'
    #test_df = pd.read_csv(folder_path, sep=',', encoding='ISO-8859-1', engine='python')
    ...
    for filename in files:
        ...
        test_df = pd.read_csv(filepath, sep=',', encoding='ISO-8859-1')
        #test_df = pd.read_csv(filepath, sep='\t', encoding='ISO-8859-1')
        #print(test_df)
        predicted_df = twitter_bot().bot_prediction_algorithm(test_df)
        for index, row in predicted_df.iterrows():
            result_d[str(row[0])] = row[1]
        #break
    ...
    with open('/media1/Fakenews/Twitter/crawler/TwitterAPI/Network/Data/bot.json', 'w') as f:
